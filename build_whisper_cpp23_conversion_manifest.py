...
requirements = [
    ...
    },
    {
        ...
        "status": "PROVED_FINITE_GREEDY_AND_STRUCTURAL",
        "evidence": f"{deadline['transition_case_count']} strict-boundary transitions and {deadline['generation_case_count']} real-audio expired-deadline runs agree with pinned MaxTimeCriteria; all runs visit 74 nodes",
    },
    {
