...
PYTHONPATH=work/venv/lib/python3.14/site-packages python3 verify_whisper_cpp23_external_assistant.py
...
work/whisper_graph_cpp23_san --external-assistant work/whisper_tiny_en/model.safetensors outputs/whisper_cpp23_tensor_manifest.tsv work/whisper_tiny_en/model.safetensors outputs/whisper_cpp23_tensor_manifest.tsv work/whisper_sample.wav outputs/whisper_cpp23_hann_f32.bin outputs/whisper_cpp23_mel_filters_f32.bin outputs/whisper_cpp23_token_manifest.tsv outputs/whisper_cpp23_token_bytes.bin 50257,50362 3 heuristic 0.9 12 >/dev/null
